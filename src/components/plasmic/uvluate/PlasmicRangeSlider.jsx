...
import SliderThumb from "../../SliderThumb"; // plasmic-import: KQNxEX1_PAkp/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: oEykOF42AI9-/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__yaOip)}
      >
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__ypL8)}>
        <div
