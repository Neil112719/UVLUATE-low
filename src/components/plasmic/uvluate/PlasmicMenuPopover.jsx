...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: Vs7h4bjUxCqD/css
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  ...
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__yg2C)}
                    label={"Item 3"}
                    value={"item3"}
                  />
