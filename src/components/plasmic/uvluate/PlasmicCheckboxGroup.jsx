...
import Checkbox from "../../Checkbox"; // plasmic-import: 35ApjmA1nZrD/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: QnI7v5KXKiJW/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__xSoIb)}
          >
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__noBCs)}
              label={<Trans__>{"Option 1"}</Trans__>}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__qilY)}
              label={<Trans__>{"Option 2"}</Trans__>}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__fr1C)}
