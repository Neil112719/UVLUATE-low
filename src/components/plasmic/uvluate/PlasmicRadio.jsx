...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: DTJGt47M8dJA/css
...
function PlasmicRadio__RenderFunc(props) {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__grGuC)}>
        <div className={classNames(projectcss.all, sty.freeBox__zomZ6)} />
      </div>
      {renderPlasmicSlot({
