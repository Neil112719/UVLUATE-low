...
import sty from "./PlasmicTooltip.module.css"; // plasmic-import: pIfEws35DTVD/css
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  ...
                  >
                    <Trans__>{"Hello from Tooltip! "}</Trans__>
                  </div>
                  <div
                    className={classNames(
                      projectcss.all,
