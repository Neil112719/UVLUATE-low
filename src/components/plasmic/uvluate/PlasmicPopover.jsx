...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: dVqy82uq2n_f/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: 2yOr_iWfuX1B/css
  ...
  return (
    <BaseDialogTrigger
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__lylUb)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
                  ...
                  >
                    <Trans__>{"This is a Popover!"}</Trans__>
                  </div>
                  <div
                    className={classNames(
                      projectcss.all,
                  ...
                  >
                    <Trans__>{"You can put anything here!"}</Trans__>
                  </div>
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__bBPgt)}
            label={<Trans__>{"Open Popover"}</Trans__>}
          />
        ),
