...
import Button from "../../Button"; // plasmic-import: 0tFnTBgOtTyn/component
...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: Ek1GGn7MyK1V/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_o31zPLSJTI4x"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__qdqdc)}>
              {$props.showHeading ? (
                <BaseHeading
                ...
                >
                  {renderPlasmicSlot({
                    defaultContents: <Trans__>{"Heading"}</Trans__>,
                    value: args.heading
                  })}
                </BaseHeading>
              ) : null}
                ...
                {renderPlasmicSlot({
                  defaultContents: (
                    ...
                    >
                      ...
                      >
                        <Trans__>{"This is a Modal!"}</Trans__>
                      </div>
                      <div
                        className={classNames(
                          projectcss.all,
              ...
              <div className={classNames(projectcss.all, sty.freeBox___8CZ4L)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__f14L6)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
...
const PlasmicDescendants = {
  ...
  ariaModal: ["ariaModal", "ariaDialog", "ariaHeading", "scrollableContent"],
  ariaDialog: ["ariaDialog", "ariaHeading", "scrollableContent"],
